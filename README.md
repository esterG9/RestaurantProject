...
הסבר תוצאות:
לפני יצירת האינדקס השאילתה ביצעה סריקה מלאה של הטבלה, ועברה על עשרות אלפי רשומות כדי למצוא את התוצאות, מה שגרם לזמן ריצה גבוה יחסית. לאחר יצירת האינדקס, השאילתה השתמשה באינדקס לצורך איתור הרשומות, ובכך זמן הריצה ירד באופן משמעותי מכ־6.694 מילישניות לכ־0.084 מילישניות.
...
הסבר תוצאות:
לפני יצירת האינדקס בוצעה סריקה מלאה של הטבלה, כאשר בסיס הנתונים עבר על כל הרשומות וסינן את אלו שאינן מתאימות. לאחר יצירת האינדקס, השאילתה השתמשה באינדקס לצורך מציאת הנתונים, דבר שהפחית את כמות הגישה לזיכרון ושיפר את זמן הריצה מכ־0.072 מילישניות לכ־0.042 מילישניות.
